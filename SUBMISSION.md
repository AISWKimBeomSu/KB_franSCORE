...
| 제출 항목 | 무엇을 낼 것인가 |
|---|---|
| **구현 코드** | 깃허브 저장소 링크 — `https://github.com/AISWKimBeomSu/KB_franSCORE` |
| **가동 서비스** | <https://kb-franscore.streamlit.app> (심사위원이 바로 눌러 볼 수 있는 화면) |
...
5. **기술설명서 제7부** — 스스로 잡은 결함 전수와 **철회한 주장 7건**
