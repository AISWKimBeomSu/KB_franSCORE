...
공정위 가맹사업 공시와 가맹본부 감사보고서로 **외식 프랜차이즈 1,442개 브랜드의 1년 내 구조악화 위험**을 산출하고,<br/>
...
| **해결** | 공정위 가맹사업 공시(오픈API **7종**)·DART 감사보고서·네이버 검색수요로 브랜드×연도 패널을 만들고, **1년 내 구조악화 확률 → 고정 등급(FS1~FS3) → 근거 소견**을 산출해 업무 화면과 문서로 제공합니다. |
